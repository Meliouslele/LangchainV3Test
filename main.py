...
async def lifespan(app: FastAPI):
    ...
    try:
        ...
        #（3）提取prompt模版
        prompt_template_system = PromptTemplate.from_file(Config.PROMPT_TEMPLATE_TXT_SYS,  encoding='utf-8' )
        prompt_template_user = PromptTemplate.from_file(Config.PROMPT_TEMPLATE_TXT_USER,  encoding='utf-8' )
